<template>
    <div>
      <div v-for="(section, sectionKey) in inventory" :key="sectionKey" class="section">
        ...
        <div :class="['section-content', { open: openSections.includes(sectionKey) }]">
          <div v-for="(subsection, subsectionKey) in section.subsections" :key="`${sectionKey}-${subsectionKey}`" class="subsection">
            ...
            <div v-for="(item, itemIndex) in subsection.items" :key="`${sectionKey}-${subsectionKey}-${itemIndex}`" 
                 class="item" :data-item-id="`${sectionKey}-${subsectionKey}-${itemIndex}`">
              <div class="item-name">
              ...
              <div class="item-actions">
                ...
                <div class="note-icon" @click="$emit('open-note', sectionKey, subsectionKey, itemIndex)">📝</div>
              </div>
            </div>
          </div>
        </div>
